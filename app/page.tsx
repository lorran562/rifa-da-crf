...
const CONFIG = {
  ...
  total: 400,
  preco: 50,
  whatsapp: "5569993990793", // 55 + DDD 69 + 99399-0793
  pixKey: "05623781209",
  pixNome: "Seu Nome Completo", // TROCAR pelo titular do PIX
  dataSorteio: "30/08/2026",
  instagram: "@shieldweb",
}

// Supabase (chave anon publica — so leitura, protegida por RLS)
...
export default function Home() {
  ...
  function comprar() {
    ...
    const msg = encodeURIComponent(
      `Ola! Quero garantir meus numeros na Rifa da ${CONFIG.premio}.\n\n` +
  ...
  return (
    <main className="min-h-screen bg-background">
        ...
        <div className="glass rounded-2xl p-6">
          <div className="mb-3 flex items-end justify-between gap-4">
            <p className="font-mono text-2xl font-bold">
              ...
              <span className="font-sans text-sm font-medium text-muted-foreground">pagos</span>
            </p>
      ...
      <section id="numeros" className="mx-auto max-w-5xl px-5 pb-12">
        ...
        <p className="mt-1 text-muted-foreground">Toque pra selecionar. Os já pagos ficam riscados.</p>
      ...
      <section className="mx-auto max-w-5xl px-5 pb-16">
        <div className="glass rounded-2xl p-6">
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            <Button size="lg" onClick={comprar} className="flex-1 text-base font-semibold">
          ...
          <p className="mt-3 text-sm text-muted-foreground">
            Ao tocar em garantir, abre meu WhatsApp com seu pedido. Faça o PIX de{" "}
            <b className="text-foreground">{brl(total)}</b> para a chave{" "}
            <span className="font-mono text-foreground">{CONFIG.pixKey}</span> e mande o comprovante. Seu número é confirmado assim que o pagamento cair.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-5xl px-5 pb-16">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          {[
            ...
            ["02", "Pague no PIX", "Fale comigo no WhatsApp, faça o PIX e mande o comprovante."],
            ["03", "Concorra", "Confirmado o pagamento, é só torcer pelo sorteio da Loteria Federal."],
          ].map(([num, titulo, desc]) => (
